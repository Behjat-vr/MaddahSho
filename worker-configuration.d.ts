/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2c647231b1d3642b2a36f9641349f17d)
// Runtime types generated with workerd@1.20260804.1 2024-09-23 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	PUBLIC_ASSETS: Fetcher;
	DATABASE_URL: string;
	EITAA_BOT_TOKEN: string;
	JWT_SECRET: string;
